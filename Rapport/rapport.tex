...
\textbf{Questionnaire annuel automatisé.} Côté admin, création/modification/suppression de questionnaires, 6 types de questions, tags KPI, questions conditionnées et cycle de vie. Côté alumni, accès au questionnaire actif, pré-remplissage et questions conditionnées masquées.
...
\begin{enumerate}
  ...
  \item \textbf{Questionnaire annuel}~: création admin (6 types de questions, tags KPI, conditions), réponse alumni pré-remplie, exploitation des KPI.
