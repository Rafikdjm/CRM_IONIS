...
L'API expose \textbf{83 endpoints} REST répartis sur \textbf{16 routeurs} (60 chemins). La liste exhaustive des méthodes et chemins est consultable directement dans la documentation Swagger générée automatiquement par FastAPI (endpoint \texttt{/docs}). Les principaux domaines sont~: Racine (1), Authentification (3), Promotions (5), Étudiants (7), Entreprises (5), Expériences (5), Certifications (8), RGPD alumni (7), RGPD admin (11), Annuaire/Indicateurs (8), Nettoyage (6), Import/Export (3), Questionnaires alumni (4), Questionnaires admin (9), Newsletter (1).
